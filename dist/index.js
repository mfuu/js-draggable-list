 ...
 * https://github.com/mfuu/draggable.js#readme
 */
...
(function (global, factory) {
  ...
  class Draggable {
    constructor(options) {
      ...
      this.scrollElement = options.scrollElement; // 滚动节点
        ...
        for (let i = 0; i < this.rectList.length; i++) {
          ...
          if (e.clientX > left && e.clientX < right && e.clientY > top && e.clientY < bottom) {
            ...
            if (this.drag.element !== this.drop.element) {
              ...
              this.drag.lastIndex = i; // 拖拽完成触发回调函数
    ...
    _getElementIndex() {
      ...
      const {
        element
      } = this.drag; // 如果能直接在子元素中找到，返回对应的index
